...
namespace System.Xaml.Permissions.Tests
{
    public class XamlLoadPermissionTests
    {
        ...
        public void Copy_Unrestricted_ReturnsExpected()
        {
            ...
            Assert.Empty(copy.AllowedAccess);
        }
        ...
        {
            Assert.Equal(expected, permission.IsSubsetOf(target));
        }
        ...
        {
            Assert.Equal(expected, permission.Intersect(target));
        }
        ...
        {
            Assert.Equal(expected, permission.Union(target));
        }
        ...
        public void FromXml_InvalidChildAssemblyName_ThrowsArgumentException(string name)
        {
            ...
            var permission = new XamlLoadPermission(PermissionState.None);
            Assert.Throws<ArgumentException>(null, () => permission.FromXml(elem));
        }
        ...
        public void FromXml_NoClassAttribute_ThrowsNullReferenceException()
        {
            var permission = new XamlLoadPermission(PermissionState.None);
            var elem = new SecurityElement("IPermission");
            Assert.Throws<NullReferenceException>(() => permission.FromXml(elem));
        }
