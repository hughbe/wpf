...
namespace System.Xaml.Tests
{
    public partial class XamlMemberTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(null, () => new XamlMember("name", null, null, new XamlSchemaContext()));
            Assert.Throws<ArgumentNullException>(null, () => new XamlMember("name", null, null, new XamlSchemaContext(), XamlMemberInvoker.UnknownInvoker));
        }
        ...
        {
            var member = new CustomXamlMember(typeof(DataClass).GetProperty(nameof(DataClass.Property)), new XamlSchemaContext()) { GetXamlNamespacesResult = new string[0] };
        ...
        public static IEnumerable<object[]> LookupDependsOn_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlMember(typeof(DataClass).GetProperty(nameof(DataClass.Property)), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new DependsOnAttribute(nameof(DataClass.Property)), new DependsOnAttribute(""), new DependsOnAttribute(nameof(DataClass.Event)) }
                    }
                },
        ...
        public void LookupDependsOn_Invoke_ReturnsExpected(SubXamlMember member, IList<XamlMember> expected)
        {
            ...
            Assert.Equal(expected ?? new XamlMember[0], member.DependsOn);
        }
        ...
        public void LookupDependsOn_NullMemberName_ThrowsArgumentNullException()
        {
            var member = new CustomXamlMember(typeof(MarkupExtensionBracketCharactersData).GetProperty(nameof(MarkupExtensionBracketCharactersData.Property)), new XamlSchemaContext())
            {
                LookupCustomAttributeProviderResult = new CustomAttributeProvider
                {
                    GetCustomAttributesResult = new object[] { new DependsOnAttribute(null) }
                }
            };
        ...
        public static IEnumerable<object[]> LookupMarkupExtensionBracketCharacters_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlMember(typeof(DataClass).GetProperty(nameof(DataClass.Property)), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new MarkupExtensionBracketCharactersAttribute('a', 'b') }
                    }
                },
        ...
        public void LookupMarkupExtensionBracketCharacters_DuplicateAttribute_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(null, () => member.LookupMarkupExtensionBracketCharactersEntry());
            Assert.Throws<ArgumentException>(null, () => member.MarkupExtensionBracketCharacters);
        }
        ...
        public static IEnumerable<object[]> LookupSerializationVisibility_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlMember(typeof(DataClass).GetProperty(nameof(DataClass.Property)), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new DesignerSerializationVisibilityAttribute(DesignerSerializationVisibility.Content) }
                    }
                },
