...
namespace System.Xaml.Tests
{
    public class XamlTypeTests
    {
        ...
        {
            AssertEqualXamlMembers(expectedGet ?? expectedLookup ?? new XamlMember[0], type.GetAllAttachableMembers());
        ...
        [Fact]
        public void LookupAllMembers_GetMemberCalledBeforeLookup_ReturnsExpected()
        {
            var type = new SubXamlType(typeof(MembersDataClass), new XamlSchemaContext());
            Assert.NotNull(type.GetMember(nameof(MembersDataClass.Property)));
            Assert.Null(type.GetMember(nameof(MembersDataClass.GetOnlyProperty)));
            Assert.Null(type.GetMember("NoSuchMember"));
            
            var expected = new XamlMember[]
            {
                new XamlMember(typeof(MembersDataClass).GetProperty(nameof(MembersDataClass.Property)), new XamlSchemaContext()),
                new XamlMember(typeof(MembersDataClass).GetProperty(nameof(MembersDataClass.SetOnlyProperty)), new XamlSchemaContext()),
                new XamlMember(typeof(MembersDataClass).GetProperty(nameof(MembersDataClass.PrivateGetProperty)), new XamlSchemaContext()),
            ...
            Assert.Equal(expected, type.GetAllMembers());
            Assert.Equal(expected, type.LookupAllMembersEntry());
        }

        [Fact]
        public void LookupAllMembers_LookupMemberFalseForProperty_ReturnsExpected()
        {
            var type = new CustomXamlType(typeof(MembersDataClass), new XamlSchemaContext())
            {
                LookupMemberResult = null
            };
            Assert.Null(type.GetMember(nameof(MembersDataClass.Property)));
            
            Assert.Equal(new XamlMember[]
            {
                new XamlMember(typeof(MembersDataClass).GetProperty(nameof(MembersDataClass.SetOnlyProperty)), new XamlSchemaContext()),
                new XamlMember(typeof(MembersDataClass).GetProperty(nameof(MembersDataClass.PrivateGetProperty)), new XamlSchemaContext()),
                new XamlMember(typeof(MembersDataClass).GetProperty(nameof(MembersDataClass.PrivateSetProperty)), new XamlSchemaContext()),
        ...
        [Fact]
        public void LookupAttachableMember_AfterGetAllAttachableMembers_ReturnsExpected()
        {
            // Make sure nothing extra is cached after we get all
            // attachable members.
            var type = new SubXamlType(typeof(AttachableMembersDataClass), new XamlSchemaContext());
            ICollection<XamlMember> expected = type.GetAllAttachableMembers();
            Assert.Equal(new XamlMember("GetSetProperty", typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.GetGetSetProperty)), typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.SetGetSetProperty)), new XamlSchemaContext()), type.GetAttachableMember("GetSetProperty"));
            Assert.Null(type.GetAttachableMember("NoSuchMember"));
            Assert.Equal(expected, type.GetAllAttachableMembers());
        }
...
#pragma warning restore 0618
        ...
        [Fact]
        public void LookupMember_AfterGetAllMembers_ReturnsExpected()
        {
            // Make sure nothing extra is cached after we get all
            // members.
            var type = new SubXamlType(typeof(MembersDataClass), new XamlSchemaContext());
            ICollection<XamlMember> expected = type.GetAllMembers();
            Assert.Equal(new XamlMember(typeof(MembersDataClass).GetProperty(nameof(MembersDataClass.Property)), new XamlSchemaContext()), type.GetMember("Property"));
            Assert.Null(type.GetMember("NoSuchMember"));
            Assert.Equal(expected, type.GetAllMembers());
        }
        ...
        {
            var type = new SubXamlType(typeof(int), new XamlSchemaContext());
            Assert.Throws<ArgumentNullException>(null, () => type.LookupMemberEntry(null, false));
