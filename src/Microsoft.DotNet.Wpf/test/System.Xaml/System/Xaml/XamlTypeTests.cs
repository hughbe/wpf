...
namespace System.Xaml.Tests
{
    public partial class XamlTypeTests
    {
        public static IEnumerable<object[]> Ctor_String_String_XamlTypeNames_XamlSchemaContext_TestData()
        {
            ...
            yield return new object[] { "unknownTypeNamespace", "unknownTypeName", new XamlType[0], new XamlSchemaContext() };
        ...
        {
            Assert.Throws<ArgumentNullException>("unknownTypeNamespace", () => new XamlType(null, "unknownTypeName", new XamlType[0], new XamlSchemaContext()));
        }

        [Fact]
        public void Ctor_NullUnknownTypeName_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>("unknownTypeName", () => new XamlType("unknownTypeNamespace", null, new XamlType[0], new XamlSchemaContext()));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>("typeName", () => new SubXamlType(null, new XamlType[0], new XamlSchemaContext()));
        }
        ...
        {
            Assert.Throws<ArgumentException>("typeArguments", () => new XamlType("unknownTypeNamespace", "unknownTypeName", new XamlType[] { null }, new XamlSchemaContext()));
            Assert.Throws<ArgumentException>("typeArguments", () => new SubXamlType("typeName", new XamlType[] { null }, new XamlSchemaContext()));
        }

        [Fact]
        public void Ctor_NullSchemaContext_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>("schemaContext", () => new XamlType("unknownTypeNamespace", "unknownTypeName", new XamlType[0], null));
            ...
            Assert.Throws<ArgumentNullException>("schemaContext", () => new SubXamlType("typeName", new XamlType[0], null));
        }
        ...
        {
            var type = new CustomXamlType(typeof(int), new XamlSchemaContext()) { GetXamlNamespacesResult = new string[0] };
        ...
        public static IEnumerable<object[]> LookupAliasedProperty_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(int), new XamlSchemaContext())
                {
                    ...
                    {
                        GetCustomAttributesResult = new object[] { new DictionaryKeyPropertyAttribute("name") }
                    }
                },
                XamlLanguage.Key,
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(int), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new RuntimeNamePropertyAttribute("name") }
                    }
                },
                XamlLanguage.Name,
                new XamlMember("name", new XamlType(typeof(int), new XamlSchemaContext()), false)
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(int), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new UidPropertyAttribute("name") }
                    }
                },
                XamlLanguage.Uid,
                new XamlMember("name", new XamlType(typeof(int), new XamlSchemaContext()), false)
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(int), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new XmlLangPropertyAttribute("name") }
                    }
                },
                XamlLanguage.Lang,
                new XamlMember("name", new XamlType(typeof(int), new XamlSchemaContext()), false)
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(int), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[0]
                    }
                },
                XamlLanguage.Lang,
                null
        ...
        public void LookupAliasedProperty_NullAttributeResult_ThrowsNullReferenceException(XamlDirective directive)
        {
            var type = new CustomXamlType(typeof(int), new XamlSchemaContext())
            {
                LookupCustomAttributeProviderResult = new CustomAttributeProvider
                {
                    GetCustomAttributesResult = null
                }
            };
        ...
        public void LookupAliasedProperty_NullItemInAttributeResult_ThrowsNullReferenceException(XamlDirective directive)
        {
            var type = new CustomXamlType(typeof(int), new XamlSchemaContext())
            {
                LookupCustomAttributeProviderResult = new CustomAttributeProvider
                {
                    GetCustomAttributesResult = new object[] { null }
                }
            };
            Assert.Throws<NullReferenceException>(() => type.LookupAliasedPropertyEntry(directive));
            Assert.Throws<NullReferenceException>(() => type.GetAliasedProperty(directive));
        ...
        public void LookupAliasedProperty_InvalidTypeItemInAttributeResult_ThrowsInvalidCastException(XamlDirective directive)
        {
            var type = new CustomXamlType(typeof(int), new XamlSchemaContext())
            {
                LookupCustomAttributeProviderResult = new CustomAttributeProvider
                {
                    GetCustomAttributesResult = new object[] { new object() }
                }
            };
        ...
        {
            yield return new object[] { new SubXamlType("namespace", "name", null, new XamlSchemaContext()), new XamlMember[0] };
            yield return new object[] { new SubXamlType("name", null, new XamlSchemaContext()), new XamlMember[0] };
            yield return new object[] { new SubXamlType(typeof(EmptyClass), new XamlSchemaContext()), new XamlMember[0] };
            yield return new object[] { new SubXamlType(typeof(object), new XamlSchemaContext()), new XamlMember[0] };
        ...
        {
            Assert.Equal(expectedGet ?? expectedLookup ?? new XamlMember[0], type.GetAllAttachableMembers());
            Assert.Equal(expectedLookup, type.LookupAllAttachableMembersEntry());
        }

        [Fact]
        public void LookupAllAttachableMembers_Invo()
        {
            var type = new SubXamlType(typeof(AttachableMembersDataClass), new XamlSchemaContext());
            XamlMember[] members = type.GetAllAttachableMembers().OrderBy(m => m.Name).ToArray();
            Assert.Equal(5, members.Length);

            Assert.Equal("DifferentFirstParameter", members[0].Name);
            Assert.Equal(typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.SetDifferentFirstParameter)), members[0].UnderlyingMember);
            Assert.Null(GetUnderlyingGetter(members[0]));
            Assert.Equal(typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.SetDifferentFirstParameter)), GetUnderlyingSetter(members[0]));

            Assert.Equal("DifferentSecondParameter", members[1].Name);
            Assert.Equal(typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.SetDifferentSecondParameter)), members[1].UnderlyingMember);
            Assert.Null(GetUnderlyingGetter(members[1]));
            Assert.Equal(typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.SetDifferentSecondParameter)), GetUnderlyingSetter(members[1]));

            Assert.Equal("Getter", members[2].Name);
            Assert.Equal(typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.GetGetter)), members[2].UnderlyingMember);
            Assert.Equal(typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.GetGetter)), GetUnderlyingGetter(members[2]));
            Assert.Null(GetUnderlyingSetter(members[2]));

            Assert.Equal("GetterSetter", members[3].Name);
            Assert.Equal(typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.GetGetterSetter)), members[3].UnderlyingMember);
            Assert.Equal(typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.GetGetterSetter)), GetUnderlyingGetter(members[3]));
            Assert.Equal(typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.SetGetterSetter)), GetUnderlyingSetter(members[3]));

            Assert.Equal("Setter", members[4].Name);
            Assert.Equal(typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.SetSetter)), members[4].UnderlyingMember);
            Assert.Null(GetUnderlyingGetter(members[4]));
            Assert.Equal(typeof(AttachableMembersDataClass).GetMethod(nameof(AttachableMembersDataClass.SetSetter)), GetUnderlyingSetter(members[4]));
        }

        [Fact]
        public void LookupAllAttachableMembers()
        {
        ...
        private static MethodInfo GetUnderlyingGetter(XamlMember member)
        {
            ...
            return (MethodInfo)underlyingGetter.Invoke(member, new object[0]);
        }
        ...
        private static MethodInfo GetUnderlyingSetter(XamlMember member)
        {
            ...
            return (MethodInfo)underlyingSetter.Invoke(member, new object[0]);
        }

        public class AttachableMembersDataClass
        {
            public static int GetGetterSetter(string value) => 0;
            public static void SetGetterSetter(string value1, int value2) { }
            ...
            public static string GetGetter(int value) => "";

            public static void SetSetter(int value1, int value2) { }
        ...
        private class DuplicateDataClass
        {
        ...
        public static IEnumerable<object[]> LookupAllMembers_TestData()
        {
            yield return new object[] { new SubXamlType("namespace", "name", null, new XamlSchemaContext()), new XamlMember[0] };
            yield return new object[] { new SubXamlType("name", null, new XamlSchemaContext()), new XamlMember[0] };
            yield return new object[] { new SubXamlType(typeof(int), new XamlSchemaContext()), new XamlMember[0] };
            yield return new object[] { new SubXamlType(typeof(object), new XamlSchemaContext()), new XamlMember[0] };
            yield return new object[] { new NoUnderlyingOrBaseType(), null };
        ...
        {
            Assert.Equal(expectedGet ?? expectedLookup ?? new XamlMember[0], type.GetAllMembers());
            Assert.Equal(expectedLookup, type.LookupAllMembersEntry());
        }
        ...
        public static IEnumerable<object[]> LookupAllowedContentTypes_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(List<string>), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new ContentWrapperAttribute(typeof(ClassWithUnknownContentPropertyAttribute)) }
                    }
                },
            ...
            yield return new object[]
            {
                new CustomXamlType("namespace", "name", null, new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new ContentWrapperAttribute(typeof(int)) }
                    }
                },
                new XamlType[] { null }
            };
        ...
        public void LookupAllowedContentTypes_Invoke_ReturnsExpected(SubXamlType type, IList<XamlType> expected)
        {
            ...
            Assert.Equal((type.IsCollection || type.IsDictionary) ? expected ?? new XamlType[0] : null, type.AllowedContentTypes);
        }

        [Fact]
        public void LookupAllowedContentTypes_NullTypeInAttribute_ThrowsNullReferenceException()
        {
        ...
        public static IEnumerable<object[]> LookupBaseType_TestData()
        {
            ...
            yield return new object[]
            {
                ...
                {
                    ExpectedGetXamlType = typeof(XamlSchemaContext),
                    GetXamlTypeResult = XamlLanguage.Single
                }),
                XamlLanguage.Single
            };
            yield return new object[]
        ...
        public static IEnumerable<object[]> LookupContentProperty_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(int), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new ContentPropertyAttribute("name") }
                    }
                },
                new XamlMember("name", new XamlType(typeof(int), new XamlSchemaContext()), false)
            };
        ...
        public void LookupContentWrappers_Invoke_ReturnsExpected(SubXamlType type, IList<XamlType> expected)
        {
            ...
            Assert.Equal(type.IsCollection ? expected ?? new XamlType[0] : expected, type.ContentWrappers);
        }

        [Fact]
        public void LookupContentWrappers_NullTypeInAttribute_ThrowsNullReferenceException()
        {
            var type = new SubXamlType(typeof(ClassWithNullContentWrapperAttribute), new XamlSchemaContext());
        ...
        public static IEnumerable<object[]> LookupDeferringLoader_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(int), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new XamlDeferLoadAttribute(typeof(int), typeof(string)) }
                    }
                },
        ...
        public static IEnumerable<object[]> LookupMarkupExtensionReturnType_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(MarkupExtension), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new MarkupExtensionReturnTypeAttribute(typeof(int)) }
                    }
                },
                new XamlType(typeof(int), new XamlSchemaContext())
            };
...
#pragma warning restore 0618
        ...
        public static IEnumerable<object[]> LookupPositionalParameters_TestData()
        {
            ...
            yield return new object[] { new SubXamlType(typeof(ArrayExtension), new XamlSchemaContext(duplicateSupport)), 0, new XamlType[0] };
        ...
        public static IEnumerable<object[]> LookupSetMarkupExtensionHandler_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(ClassWithXamlSetMarkupExtensionEventArgsDelegate), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new XamlSetMarkupExtensionAttribute("Method") }
                    }
                },
            ...
            yield return new object[]
            {
                new CustomXamlType("namespace", "name", null, new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new XamlSetMarkupExtensionAttribute("name") }
                    }
                },
                null
            };
        ...
        public void LookupSetMarkupExtensionHandler_NoSuchName_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(null, () => type.LookupSetMarkupExtensionHandlerEntry());
        }
        ...
        public static IEnumerable<object[]> LookupSetTypeConverterHandler_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(ClassWithXamlSetTypeConverterEventArgsDelegate), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new XamlSetTypeConverterAttribute("Method") }
                    }
                },
            ...
            yield return new object[]
            {
                new CustomXamlType("namespace", "name", null, new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new XamlSetTypeConverterAttribute("name") }
                    }
                },
                null
            };
        ...
        public void LookupSetTypeConverterHandler_NoSuchName_ThrowsArgumentException()
        {
            ...
            Assert.Throws<ArgumentException>(null, () => type.LookupSetTypeConverterHandlerEntry());
        }
        ...
        public static IEnumerable<object[]> LookupTypeConverter_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(int), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new TypeConverterAttribute(typeof(string)) }
                    }
                },
            ...
            yield return new object[]
            {
                new CustomXamlType("namespace", "name", null, new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new TypeConverterAttribute(typeof(int)) }
                    }
                },
                null
            };
        ...
        public static IEnumerable<object[]> LookupUsableDuringInitialization_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(int), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new UsableDuringInitializationAttribute(true) }
                    }
                },
                true
            };
        ...
        public static IEnumerable<object[]> LookupValueSerializer_TestData()
        {
            ...
            yield return new object[]
            {
                new CustomXamlType(typeof(int), new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new ValueSerializerAttribute(typeof(string)) }
                    }
                },
            ...
            yield return new object[]
            {
                new CustomXamlType("namespace", "name", null, new XamlSchemaContext())
                {
                    LookupCustomAttributeProviderResult = new CustomAttributeProvider
                    {
                        GetCustomAttributesResult = new object[] { new ValueSerializerAttribute(typeof(int)) }
                    }
                },
                null
            };
        ...
        public static IEnumerable<object[]> CanAssignTo_TestData()
        {
            ...
            differentVersionAssemblyName.Version = new Version(2, 0);
            ...
            differentCultureAssemblyName.CultureInfo = new CultureInfo("fr-FR");
            ...
            foreach (byte[] keyToken in new object[] { null, new byte[0], new byte[] { 183, 122, 92, 86, 25, 52, 224, 137 } })
            {
            ...
            windowsBaseAssemblyName.Name = "WindowsBase";
            ...
            invalidWindowsBaseAssemblyName.Name = "BadWindowsBase";
            ...
            foreach (byte[] keyToken in new object[] { null, new byte[0], new byte[] { 183, 122, 92, 86, 25, 52, 224, 137 } })
            {
                ...
                invalidKeyTokenWindowsBaseAssemblyName.Name = "WindowsBase";
            ...
            nullInterface.GetInterfacesResult = new Type[] { null };
            yield return new object[]
            {
            ...
            nullConstrainedGenericParameter.GetGenericParameterConstraintsResult = new Type[] { null };
            yield return new object[]
            {
                new XamlType(new ReflectionOnlyType(typeof(int)), new XamlSchemaContext()),
            ...
            constrainedGenericParameter.GetGenericParameterConstraintsResult = new Type[] { typeof(XamlObjectWriterSettings) };
            yield return new object[]
            {
                new XamlType(new ReflectionOnlyType(typeof(XamlObjectWriterSettings)), new XamlSchemaContext()),
