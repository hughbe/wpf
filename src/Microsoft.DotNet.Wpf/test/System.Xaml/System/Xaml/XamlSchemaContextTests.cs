...
namespace System.Xaml.Tests
{
    public class XamlSchemaContextTests
    {
        ...
        public void GetXamlType_OverridenGetXamlTypeType_ReturnsNull()
        {
            ...
            {
                ExpectedGetXamlType = typeof(int),
        ...
        public static IEnumerable<object[]> GetXamlType_ReferencesAssemblies_TestData()
        {
            ...
            noVersionAssemblyName.Version = null;
            yield return new object[]
            {
            ...
            noCultureAssemblyName.CultureInfo = null;
            yield return new object[]
            {
            ...
            incorrectVersionAssemblyName.Version = new Version(1, 2, 3, 4);
            yield return new object[]
            {
            ...
            incorrectCultureAssemblyName.CultureInfo = new CultureInfo("en");
            yield return new object[]
            {
