...
namespace System.Xaml.Schema.Tests
{
    public class XamlTypeNameTests
    {
        ...
        public static IEnumerable<object[]> Ctor_String_String_XamlTypeNames_TestData()
        {
            ...
            yield return new object[] { "", "", new XamlTypeName[0] };
        ...
        public void Ctor_String_String_XamlTypeNames(string xamlNamespace, string name, IEnumerable<XamlTypeName> typeArguments)
        {
            ...
            Assert.Equal(xamlNamespace, typeName.Namespace);
            Assert.Equal(name, typeName.Name);
            Assert.Equal(typeArguments ?? new XamlTypeName[0], typeName.TypeArguments);
        }
        ...
        public static IEnumerable<object[]> ToString_TestData()
        {
            ...
            yield return new object[] { new XamlTypeName("namespace", "name[value]", new XamlTypeName[0]), null, "{namespace}name[value]" };
            ...
            yield return new object[]
            {
                ...
                {
                    ExpectedNamespaces = new string[] { "namespace" },
            ...
            yield return new object[]
            {
                ...
                new CustomNamespacePrefixLookup
                {
                    ExpectedNamespaces = new string[] { "namespace", "typeNamespace" },
                    Prefixes = new string[] { "prefix", "prefix" } },
        ...
        {
            var prefixLookup = new CustomNamespacePrefixLookup { Prefixes = new string[] { "prefix", "prefix", "prefix" } };
        ...
        {
            var prefixLookup = new CustomNamespacePrefixLookup { Prefixes = new string[] { null, null } };
            var typeName = new XamlTypeName("namespace", "name", new XamlTypeName[] { null });
        ...
        public void ToString_ListInvoke_ReturnsExpected(IList<XamlTypeName> typeNameList, string expected)
        {
            ...
            {
                ExpectedNamespaces = new string[] { "namespace1", "namespace2"},
        ...
        {
            Assert.Throws<ArgumentNullException>("prefixLookup", () => XamlTypeName.ToString(new XamlTypeName[0], null));
        }

        public static IEnumerable<object[]> Parse_TestData()
        {
            yield return new object[] { "name", "", "name", new XamlTypeName[0] };
            yield return new object[] { "  name  ", "", "name", new XamlTypeName[0] };
            yield return new object[] { "_name", "", "_name", new XamlTypeName[0] };
            yield return new object[] { "prefix:name", "prefix", "name", new XamlTypeName[0] };
            yield return new object[] { "  prefix  :  name  ", "prefix", "name", new XamlTypeName[0] };
            yield return new object[] { "_aA.1e\u0300\u0903:_bB1ee\u0300\u0903", "_aA.1e\u0300\u0903", "_bB1ee\u0300\u0903", new XamlTypeName[0] };
