...
namespace System.Xaml.Schema.Tests
{
    public class XamlValueConverterTests
    {
        ...
        {
            Assert.Throws<ArgumentException>(null, () => new XamlValueConverter<string>(null, null));
            Assert.Throws<ArgumentException>(null, () => new XamlValueConverter<string>(null, null, null));
        }
