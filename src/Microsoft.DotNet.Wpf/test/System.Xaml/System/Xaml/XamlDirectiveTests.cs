...
namespace System.Xaml.Tests
{
    public class XamlDirectiveTests
    {
        public static IEnumerable<object[]> Ctor_Strings_String_XamlType_XamlValueConverter_AllowedMembersLocation_TestData()
        {
            ...
            yield return new object[] { new string[0], "name", null, AllowedMemberLocations.None - 1 };
        }
        ...
        public static IEnumerable<object[]> Equals_TestData()
        {
            ...
            yield return new object[] { directive, new XamlDirective(new string[0], "name", type1, null, AllowedMemberLocations.Any), false };
        ...
        {
            var type = new XamlType("unknownTypeNamespace", "unknownTypeName", null, new XamlSchemaContext());
            yield return new object[] { new XamlDirective(new string[0], "name", type, null, AllowedMemberLocations.Any), "name" };
        ...
        public void LookupTypeConverter_Get_ReturnsExpected()
        {
            ...
            var converter = new SubXamlDirective(new string[0], "name", type, typeConverter, AllowedMemberLocations.Any);
        ...
        {
            var type = new XamlType("unknownTypeNamespace", "unknownTypeName", null, new XamlSchemaContext());
            var converter = new SubXamlDirective(new string[0], "name", type, null, AllowedMemberLocations.Any);
